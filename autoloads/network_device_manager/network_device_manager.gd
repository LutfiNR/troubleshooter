...
# Exported starter devices
@export var export_computer_devices : Array[ComputerDevice]
# @export var export_server_devices : Array[ServerDevice]
# @export var export_router_devices : Array[RouterDevice]
# @export var export_switch_devices : Array[SwitchDevice]
...
func _ready() -> void:
	for device_data in export_computer_devices:
		computer_devices[device_data.device_id] = device_data

func setup_device_data(device_data: NetworkDevice)-> void:
