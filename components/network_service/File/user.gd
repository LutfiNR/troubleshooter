class_name SambaUser extends Resource
@export var username: String = ""
@export var password: String = ""


func verify_configuration(runtime_user: SambaUser = null) -> Dictionary:
	...
	return {
		"status": (res_username.status and res_password.status),
